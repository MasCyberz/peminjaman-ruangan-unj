                        ...
                        <tbody class="text-left">
                            @foreach ($suratList as $surat)
                                <tr>
                                    ...
                                    <td class="px-6 py-2 whitespace-nowrap border-x border-black text-sm"> @php
                                        try {
                                            echo \Carbon\Carbon::parse($surat->mulai_dipinjam)->format('d-m-Y');
                                        } catch (\Exception $e) {
                                            echo 'Invalid Date';
                                        }
                                    @endphp
                                    ...
                                    <td class="px-6 py-2 whitespace-nowrap border-x border-black text-sm"> @php
                                        try {
                                            echo \Carbon\Carbon::parse($surat->akhir_dipinjam)->format('d-m-Y');
                                        } catch (\Exception $e) {
                                            echo 'Invalid Date';
                                        }
                                    @endphp
