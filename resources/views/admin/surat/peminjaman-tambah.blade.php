...
@section('content')
    ...
    <div class="rounded-lg shadow-all-side w-[80%] h-auto pb-4 my-5 mx-auto">
        ...
        <form class="mx-10 " action="{{ route('surat_store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div id="peminjamanFields">
                <div class="peminjaman">
                    <div>
                        ...
                        <input type="date" id="tanggal_0" name="tanggal_peminjaman[]" class="mt-1 p-2 border border-gray-300 rounded-md w-full" min="{{ date('Y-m-d') }}">
                    </div>
                ...
                @enderror
                    <div>
                        ...
                        <input type="number" id="jml_ruang_0" name="jml_ruang[]" class="mt-1 p-2 border border-gray-300 rounded-md w-full">
                    </div>
                    @error('jml_ruang')
                    <p class="text-red-500 text-sm mt-1 capitalize">{{ $message }}</p>
                @enderror
                    <div>
                        ...
                        <input type="number" id="jml_pc_0" name="jml_pc[]" class="mt-1 p-2 border border-gray-300 rounded-md w-full">
                    </div>
                    @error('jml_pc')
                    <p class="text-red-500 text-sm mt-1 capitalize">{{ $message }}</p>
                @enderror
            ...
            <div class="mt-4">
                <button type="button" id="tambahPeminjaman" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Tambah Peminjaman</button>
            </div>
