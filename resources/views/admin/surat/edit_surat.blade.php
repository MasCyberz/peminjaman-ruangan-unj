...
<div class="rounded-lg shadow-all-side w-[80%] h-auto pb-4 my-5 mx-auto">
    ...
    <form class="mx-10 " action="{{ route('update_surat', ['id' => $SuratYgDiedit->id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="mb-2">
        ...
        <div class="mb-2">
            ...
            <input type="date" id="mulai_dipinjam" name="mulai_dipinjam" value="{{ $SuratYgDiedit->mulai_dipinjam }}"
        ...
        <div class="mb-2">
            ...
            <input type="date" id="selesai_dipinjam" name="selesai_dipinjam" value="{{ $SuratYgDiedit->selesai_dipinjam }}"
                class="bg-gray-300 border border-gray-300 text-gray-900 text-sm rounded-full outline-none ps-5 block w-full p-1.5" min="{{ date('Y-m-d') }}" />
                @error('nama_peminjam')
                <p class="text-red-500 text-sm mt-1 capitalize">{{ $message }}</p>
            @enderror
        ...
        <div class="mb-2">
            ...
            <input type="number" id="jml_ruang" name="jml_ruang" value="{{ $SuratYgDiedit->jml_ruang }}"
        ...
        <div class="mb-2">
            ...
            <input type="number" id="jml_pc" name="jml_pc" value="{{ $SuratYgDiedit->jml_pc }}"
        ...
        <div class="flex gap-2 mt-5 items-center">
            <input type="file" id="file" name="file" class="hidden" value="{{ $SuratYgDiedit->file_surat }}" onchange="displayFileName()">
            <label for="file"
