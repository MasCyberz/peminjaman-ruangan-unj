...
<div class="rounded-lg shadow-all-side w-[80%] my-5 p-8 mx-auto">
    <form class="mx-10" action="{{ route('ruangan_update', ['id' => $ruanganList->id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="mb-2">
            ...
            <input type="number" id="kapasitas_orang" name="kapasitas_orang" value="{{ $ruanganList->kapasitas_orang }}"
                class="bg-gray-300 border border-gray-300 text-gray-900 text-sm rounded-full outline-none ps-5 block w-full p-1.5" />
        </div>
