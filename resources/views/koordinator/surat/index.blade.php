...
@section('content')
    ...
    <div class="w-[90%] h-full mx-auto py-3 px-4">
        <div class="w-[936px] h-[90px] shadow-all-side flex mx-auto mt-10 px-5 py-3">
            <svg class="w-10 h-10 text-gray-800 my-1 mx-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="flex items-center justify-center h-48 gap-4 mt-14 rounded text-white">
            <div
                ...
                <div class="flex m-5">
                    <div class="w-[65%] h-full my-auto mx-5">
                        <span class="whitespace-nowrap block text-3xl font-semibold align-middle">{{ $permintaanRuang }}</span>
                ...
                <a href="{{ route('pengajuan_koordinator') }}">
                    <div
            ...
            <div
                class="w-[425px] h-[225px] bg-gray-500 rounded-lg relative hover:scale-105 transition-all duration-500 ease-in-out">
                <div class="flex m-5">
                    <div class="w-[65%] h-full my-auto mx-5">
                        <span class="whitespace-nowrap block text-3xl font-semibold align-middle text-center">Data</span>
                        <span
                            class="whitespace-nowrap block text-2xl font-semibold align-middle text-center">Referensi</span>
                    </div>
                    <div class="w-full h-full flex justify-center items-center mx-5">
                        <i class='bx bxs-file-find text-[150px]'></i>
                    </div>
                </div>
                <a href="{{ route('referensi_koordinator') }}">
                    <div
                        class="bg-gray-700 w-full h-8 absolute bottom-0 left-0 flex items-center justify-center rounded-lg cursor-pointer">
                        <span class="my-auto">Selengkapnya</span>
                        <i class='bx bxs-right-arrow-circle ms-2 text-2xl my-auto'></i>
                    </div>
                </a>
